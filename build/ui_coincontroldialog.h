...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 PUSH"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 PUSH"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 PUSH"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 PUSH"));
