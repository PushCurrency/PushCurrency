...
/**
 * Split PushCurrency command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the PushCurrency RPC console.") + "<br>" +
