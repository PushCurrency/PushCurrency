    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    ui->txhashLineEdit->setPlaceholderText("Enter your 5000 PUSH TXID");
    ui->outputindexLineEdit->setPlaceholderText("Enter your transaction output index");
    ui->donationaddressLineEdit->setPlaceholderText("Enter aPUSHaddress for your MN donation");
...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (123.45.67.89:50003)");
        msg.exec();
        return;
    }
